...
namespace Bumeran\Common\Symfony\Profiler\Storage;

/**
 * Base Memcache storage for profiling information in a Memcache.
 *
 * @codingStandardsIgnoreStart
 * From  {@link} https://github.com/symfony/symfony/blob/2.7/src/Symfony/Component/HttpKernel/Profiler/MemcacheProfilerStorage.php
...
class MemcacheProfilerStorage extends BaseMemcacheProfilerStorage
{
    ...
    protected function appendValue($key, $value, $expiration = 0)
    {
        ...
        return $memcache->set($key, $memcache->get($key) . $value, false, $expiration);
    }
}
